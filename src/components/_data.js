module.exports = {
  elements: [
    ...
    },
    {
      ...
      summary:
        'Helium is a decentralized file manager that allows the users to upload, download and share files on IPFS (InterPlanetary File System) and allows them to be certified against the Ethereum Blockchain. Currently is available for both iOS and Android.',
      symbol: 'He',
      xpos: 18,
      ypos: 1,
      shells: [2]
    ...
    },
    {
      ...
      summary:
        'Carbon is an atom that handles CIDARO customers data; it is made with NodeJS, receives gRPC connections from Oxygen and communicates with the other microservices using Redis queues.',
      symbol: 'C',
      xpos: 14,
      ypos: 2,
      shells: [2, 4]
    },
    {
      ...
      period: 2,
      phase: 'Gas',
      source: 'https://github.com/CIDARO/nitrogen',
      spectral_img: 'https://en.wikipedia.org/wiki/File:Nitrogen_Spectra.jpg',
      summary:
        'Nitrogen is a CLI made with NodeJS for listening and exporting Ethereum Smart Contract event; it can be installed globally using npm since it\'s publicly available.',
      symbol: 'N',
      xpos: 15,
      ypos: 2,
      shells: [2, 5]
    },
    {
      ...
      summary:
        'Oxygen is the NodeJS Gateway API service for all CIDARO atoms; it\'s fault-resilient, highly-available and scalable at ease.',
      symbol: 'O',
      xpos: 16,
      ypos: 2,
      shells: [2, 6]
    },
    {
      ...
      spectral_img: null,
      summary:
        'Fluorine is a Docker container sidecar that recovers and stores metrics from a CIDARO atom; it\'s so reactive that loves staying with our noble gases atoms!',
      symbol: 'F',
      xpos: 17,
      ypos: 2,
      shells: [2, 7]
    ...
    },
    {
      ...
      period: 4,
      phase: 'Solid',
      source: 'https://github.com/CIDARO/cobalt',
      spectral_img: null,
      summary:
        'Cobalt is an Open Source LRU Cache written for Deno; it\'s documentation can be read also from the official Deno site: https://doc.deno.land/https/deno.land/x/cobalt/mod.ts.',
      symbol: 'Co',
      xpos: 9,
      ypos: 4,
      shells: [2, 8, 15, 2]
    ...
    },
    {
      ...
      spectral_img: null,
      summary:
        'Copper is an atom that receives error logs from all the other microservices, displays them and allows customized search for better error analysis.',
      symbol: 'Cu',
      xpos: 11,
      ypos: 4,
      shells: [2, 8, 18, 1]
    },
    {
      ...
      period: 4,
      phase: 'Solid',
      source: 'https://github.com/CIDARO/zinc',
      spectral_img: null,
      summary:
        'Zinc is an Open Source ERC-20 + ERC-721 Ethereum Testnet faucet. It allows developers to easily mint batches of ERC-20 and ERC-721 tokens using a simple UI. Currently the only Ethereum Testnets supported are Rinkeby and Ropsten. You can use Zinc at the following link: https://zinc.cidaro.com.',
      symbol: 'Zn',
      xpos: 12,
      ypos: 4,
      shells: [2, 8, 18, 2]
    ...
    },
    {
      ...
      period: 5,
      phase: 'Solid',
      source: 'https://github.com/CIDARO/tin',
      spectral_img: null,
      summary:
        'Tin is a lightweight Open Source Key/Value storage atom developed in Rust. It\'s currently in apha version, so maybe you can help us developing it!',
      symbol: 'Sn',
      xpos: 14,
      ypos: 5,
      shells: [2, 8, 18, 18, 4]
    ...
    },
    {
      ...
      period: 6,
      phase: 'Solid',
      source: 'https://github.com/CIDARO/iridium',
      spectral_img: null,
      summary:
        'Iridium is an Open Source Reverse HTTP Proxy that stores metrics written in Go. It\'s currently in apha version, so maybe you can help us developing it!',
      symbol: 'Ir',
      xpos: 9,
      ypos: 6,
    ...
    },
    {
      ...
      spectral_img: null,
      summary:
        'Gold is the atom that handles all the customers\' payments and dispatches the events on the Redis queues for all the other services.',
      symbol: 'Au',
      xpos: 11,
      ypos: 6,
    ...
    },
    {
      ...
      period: 6,
      phase: 'Solid',
      source: 'https://github.com/CIDARO/bismuth',
      spectral_img: null,
      summary:
        'Bismuth is an atom that simply visualizes the current CIDARO atoms infrastructure. Nothing less, nothing more. You can explore it at the following link: https://bismuth.cidaro.com.',
      symbol: 'Bi',
      xpos: 15,
      ypos: 6,
